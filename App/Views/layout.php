...
<head>
    ...
    <base href="<?php  echo 'http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/App/Views/">

    <title>Empregar</title>
            ...
            <div class="row">
                ...
                <div class="footer-col col-md-4">
                    ...
                    <p>Freelance is a free to use, open source Bootstrap theme created by <a
                            href="http://startbootstrap.com">Empregar</a>.</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="js/empregar.js"></script>
