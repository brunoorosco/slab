		...
		<form id="form_cadEmpresas" name="frm_cadEmpresas" action="php/cadastro.php" method="post">
			...
			<div class="row">
				<div class="col">
					...
					<input type="text" name="txt_codcliente" onclick="cor(this);" class="cx_numeros form-control" maxlength="10" id="cx1_CadEmpresas" value="<?php if (isset($codCliente)) {
																																									echo $codCliente;
																																								} ?>" />
				</div>
				<div class="col">
			...
			<input type="text" name="txt_ie" onclick="cor(this);" class="cx_texto2" id="cx4_CadEmpresas form-control" value="<?php if (isset($ie)) {
																																	echo $ie;
																																} ?>" />
			...
			<input type="text" name="txt_fax" onclick="cor(this);" class="cx_texto2" id="cx14_CadEmpresas form-control" value="<?php if (isset($fax)) {
																																	echo $fax;
																																} ?>" />
