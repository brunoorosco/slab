<?php
	...
	if (isset($_GET['editar'])) {
		...
		$_SESSION['CODUPDPROD'] = $codigo;
		
		$sql = "Select Codigo, Nome, Preco from produtos where Codigo = $codigo";
	...
	if(isset($_GET['excluir'])) {
		...
		$sql = "Update produtos set Status = 1 where Codigo = $codigo";
...
<?php
	...
	$sql = "Select COUNT(*) from produtos where Status = 0";
...
<html>
	...
	<head>
		...
		<!-- ARQUIVOS CSS IMPORTADOS -->
			...
			<link rel="stylesheet" type="text/css" href="../styles/cadProdutos.css">
		...
		<div class="principal">
			...
			<span class="paragrafo" id="ini_tit1">Solicitar</span>
					...
					<div class="submenu_cont">
						...
						<!-- OPÇÕES PARA CADASTROS -->
							...
							<ul class="listas" id="ini_lst2" type="square">
								...
								<li><a href="#" class="lk_lista">Produtos</a></li>
				...
				<div id="cont2">
					...
					<span class="subtitulo2" id="ini_tit4">Cadastramento de produtos de ensaio</span>
					
					
					<!-- FORMULÁRIO DO CADASTRO -->
					
					<form name="frm_cadProdutos" action="php/cadastro.php" method="post">
					
						<span class="texto" id="cadProduto_tit1">Produto</span>
						
						<input class="cx_texto2" id="cx2_cadProdutos" name="txt_produto" onclick="cor(this);" maxlength="150" value="<?php if(isset($nome)) { echo $nome; } ?>" />
						
						<span class="texto" id="cadProduto_tit2">Preço</span>
						
						<input class="cx_precos" id="cx1_cadProdutos" name="txt_preco" onclick="cor(this);" maxlength="150" value="<?php if(isset($preco)) { echo $preco; } ?>" />
					...
					<span class="texto" id="cadProdutos_tit6">Produto</span>
					
					<span class="texto" id="cadProdutos_tit7">Preço Fixo</span>					
					
					
					<div id="tabelaCadProdutos">
						...
						<?php						
							...
							$sql = "Select Codigo, Nome, Preco from produtos where status = 0 order by 'Codigo' desc limit $paginador, 11";
						...
						?>
								...
								<tr>
									...
									<td id="linha1_tabelaProdutos"><?php echo $rf['Nome']; ?></td>	
									<td id="linha3_tabelaProdutos">R$ <?php echo $preco; ?></td>
									<td id="linha4_tabelaProdutos"><a href="index.php?excluir=<?php echo($rf['Codigo']); ?>"><img src="../imagens/png/bt_excluirEditar.png" /></a></td>
									<td id="linha5_tabelaProdutos"><a href="index.php?editar=<?php echo($rf['Codigo']); ?>"><img src="../imagens/png/bt_Editar.png" /></a></td>
