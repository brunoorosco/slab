                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Tiago Gouvêa</strong>
                             </span> <span class="text-muted text-xs block">Viciado em café <b class="caret"></b></span> </span> </a>
